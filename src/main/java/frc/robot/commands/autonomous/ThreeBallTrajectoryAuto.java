...
public class ThreeBallTrajectoryAuto extends SequentialCommandGroup {
	public ThreeBallTrajectoryAuto(Drivetrain drivetrain, Intake intake, Manipulator manipulator) {
		super(
